app_name=openjdk
version=8u432-slim-12.10-mysql
...
docker build -f Dockerfile-mysql --platform linux/amd64 ${proxy_arg} -t ${img2} .
docker build -f Dockerfile-mysql --platform linux/arm64 ${proxy_arg} -t ${img3} .
